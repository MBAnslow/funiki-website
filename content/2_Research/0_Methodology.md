...
When it comes to the use of AI, we want to focus on understanding the support that different types of creators might need. AI serves as an additional tool that needs to be iterated on and refined along with the rest of the Funiki engine. The ultimate goal of the project is to support open-ended generation allowing non-technical users to create ambiences and opening the door for real-time applications.

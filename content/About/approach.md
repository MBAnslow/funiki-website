...
Funiki is a long horizon research project. It doesn't have specific long term goals or deliverables but rather a mission and an evolving direction. Rather than working on isolated research problems from a purley academic perspective, we take a **systems first** approach.

Individual lines of inquiry are imagined in terms of the broader Funiki system as contributions across components. This allows for individual contributions to keep within a global vision and direction. Moreover, it ensures that advancements are realised as tangible artefacts that can be interacted with by creators as the project evolves.

This is opposed to isolated academic contexts where problems might not contribute meaningfully or practically outside of their specific scope. This allows questions related to interactions between components and usage of the system that might not be obvious otherwise. At the same time this approach can motivate new academic pursuits and new or augmented systems.
